...
namespace ProjectNA.DataLayer.Migrations
{
    ...
    [Migration("20210829232745_mig_Clothing5")]
    partial class mig_Clothing5
    {
            ...
            modelBuilder.Entity("ProjectNA.DataLayer.Entities.Clothing.Clothing", b =>
                {
                    ...
                    b.Property<int?>("NeStatusStatusId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjectNA.DataLayer.Entities.Clothing.Clothing", b =>
                {
                    ...
                    b.HasOne("ProjectNA.DataLayer.Entities.Clothing.ClothingStatus", "NeStatus")
                        .WithMany("Clothings")
                        .HasForeignKey("NeStatusStatusId");
